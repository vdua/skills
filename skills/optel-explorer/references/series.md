...
**Source**: `skills/optel-explorer/scripts/optel-query.jsh` → `formBlockLoadTime()` (inlined from the former `facets.js`)
...
**Source**: `skills/optel-explorer/scripts/optel-query.jsh` → `timeOnPage` (inlined from the former `series.js`)
